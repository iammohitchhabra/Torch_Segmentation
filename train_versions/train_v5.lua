...
i1=nn.Sequential()
i1:add(cudnn.SpatialConvolution(3,16,3,3,2,2,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
i2=nn.Sequential()
...
bt2_1:add(nn.SpatialBatchNormalization(32, 1e-3))
bt2_1:add(cudnn.ReLU(true))
bt2_1:add(nn.nn.SpatialDropout((0.1))
bt2_2=nn.Sequential()
...
bt3_1:add(cudnn.ReLU(true))
bt3_1:add(nn.nn.SpatialDropout((0.1))
bt3_2=nn.Sequential()
...
bt4_1:add(cudnn.ReLU(true))
bt4_1:add(nn.nn.SpatialDropout((0.1))
bt4_2=nn.Sequential()
...
bt5_1:add(cudnn.ReLU(true))
bt5_1:add(nn.nn.SpatialDropout((0.1))
bt5_2=nn.Sequential()
...
bt6_1:add(cudnn.ReLU(true))
bt6_1:add(nn.nn.SpatialDropout((0.1))
bt6_2=nn.Sequential()
...
bt7_1:add(cudnn.SpatialConvolution(64,64,5,1,1,1,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
bt7_1:add(cudnn.SpatialConvolution(64,64,1,5,1,1,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
bt7_1:add(nn.SpatialBatchNormalization(64,1e-3))
bt7_1:add(cudnn.ReLU(true))
...
bt7_1:add(cudnn.ReLU(true))
bt7_1:add(nn.nn.SpatialDropout((0.1))
bt7_2=nn.Sequential()
...
dbt1_1:add(cudnn.SpatialConvolution(64,64,5,1,1,1,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
dbt1_1:add(cudnn.SpatialConvolution(64,64,1,5,1,1,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
dbt1_1:add(nn.SpatialBatchNormalization(64,1e-3))
dbt1_1:add(cudnn.ReLU(true))
...
dbt1_1:add(cudnn.ReLU(true))
dbt1_1:add(nn.nn.SpatialDropout((0.1))
dbt1_2=nn.Sequential()
dbt1_2:add(cudnn.SpatialConvolution(64,32,1,1,1,1):init('weight', nninit.xavier, {dist = 'normal', gain = 1.1}))
dbt1_2:add(nn.SpatialBatchNormalization(32, 1e-3))
dbt1_2:add(cudnn.SpatialMaxPooling(3,3,1,1,1,1))
dbotleneck1:add(dbt1_1)
dbottleneck1:add(dbt1_2)
SegModel:add(ebottleneck1)
SegModel:add(nn.JoinTable(2,4))
...
--close the hdf5 file
myFile:close()
graph.dot(SegModel.fg, 'SegModel', 'SegModel')
print(SegModel)
