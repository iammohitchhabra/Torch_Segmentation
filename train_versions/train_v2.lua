...
SegModel:add(cudnn.SpatialConvolution(3,5,9,9,3,3))
SegModel:add(nn.SpatialBatchNormalization(5, 1e-3))
SegModel:add(cudnn.ReLU(true))
SegModel:add(cudnn.SpatialConvolution(5,10,5,5,2,2))
SegModel:add(nn.SpatialBatchNormalization(10, 1e-3))
SegModel:add(cudnn.ReLU(true))
SegModel:add(cudnn.SpatialConvolution(10,10,3,3,1,1))
SegModel:add(nn.SpatialBatchNormalization(10, 1e-3))
SegModel:add(cudnn.ReLU(true))

--nn.SpatialFullConvolution(nInputPlane, nOutputPlane, kW, kH, [dW], [dH], [padW], [padH], [adjW], [adjH])
SegModel:add(cudnn.SpatialFullConvolution(10,10,3,3,1,1))
SegModel:add(nn.SpatialBatchNormalization(10, 1e-3))
SegModel:add(cudnn.ReLU(true))
SegModel:add(cudnn.SpatialFullConvolution(10,10,5,5,2,2))
SegModel:add(nn.SpatialBatchNormalization(10, 1e-3))
SegModel:add(cudnn.ReLU(true))
SegModel:add(cudnn.SpatialFullConvolution(10,10,12,12,3,3))
--


SegModel:add(nn.SpatialBatchNormalization(10,1e-3))
SegModel:add(cudnn.ReLU(true))
SegModel:add(cudnn.SpatialFullConvolution(10,2,1,1,1,1))
